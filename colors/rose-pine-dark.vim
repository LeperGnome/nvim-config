...
hi SpecialComment guifg=#635c96 gui=italic guibg=#191724
hi StatusLineNC gui=NONE guibg=#31748f guifg=#e0def4
hi Search guibg=#9a02a3 guifg=NONE
hi Title guifg=#e0def4
hi StatusLine gui=bold guifg=#e0def4 guibg=#706e86
hi Comment guifg=#706e86 gui=italic
hi CursorLine guibg=#313040
hi TabLineFill gui=NONE guibg=#706e86
hi VertSplit gui=NONE guifg=#313040 guibg=NONE
hi Visual gui=NONE guibg=#313040 cterm=reverse
hi TabLine guifg=#5045c1 guibg=#706e86 gui=NONE
hi LineNr guifg=#5045c1 guibg=NONE

hi Pmenu guifg=#a8a8a8 guibg=#1f1e29 gui=NONE cterm=NONE
hi PmenuSbar guifg=#303030 guibg=#1f1e29 gui=NONE cterm=NONE
hi PmenuSel guifg=#a8a8a8 guibg=#1f1e29 gui=reverse cterm=reverse
